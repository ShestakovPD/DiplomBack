            ...
            @isset($product)
                @foreach ($product as $prod)
                    ...
                    <div class="products-columns__item">
                        ...
                        <div class="products-columns__item__thumbnail"><a href='{{url("$url")}}' class="products-columns__item__thumbnail__link"><img src="{{URL::asset($product[($prod['id'])-1]->img)}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
    ...
    {{--        <div class="content-middle">--}}
            <div class="cart-product-list">
                    ...
                    <div class="cart-product-list__item">
                            ...
                            <div class="cart-product__item__product-photo"><img src="{{URL::asset($orderq->img)}}" class="cart-product__item__product-photo__image"></div>
                            <div class="cart-product__item__product-name">
                                <div class="cart-product__item__product-name__content"><a href="#">{{ $orderq->name_prod }}</a></div>
                            </div>
                            <div class="cart-product__item__cart-date">
                                <div class="cart-product__item__cart-date__content">{{ $orderq->created_at }}</div>
                            </div>
                            <div class="cart-product__item__product-price"><span class="product-price__value">{{ $orderq->price }} рублей</span></div>
                    </div>
                    @endforeach
